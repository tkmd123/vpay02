    ...
    return (
      <div>
        <h2 id="partner-log-heading">
          <Translate contentKey="vpay02App.partnerLog.home.title">Partner Logs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="vpay02App.partnerLog.home.createLabel">Create new Partner Log</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('vpay02App.partnerLog.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('partnerLogAmount')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogAmount">Partner Log Amount</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogTransRef')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogTransRef">Partner Log Trans Ref</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogUsername')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogUsername">Partner Log Username</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogProductTypeCode')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogProductTypeCode">Partner Log Product Type Code</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogResultCode')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogResultCode">Partner Log Result Code</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogResultDesc')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogResultDesc">Partner Log Result Desc</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogDate')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogDate">Partner Log Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogUDF1')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogUDF1">Partner Log UDF 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogUDF2')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogUDF2">Partner Log UDF 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogUDF3')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogUDF3">Partner Log UDF 3</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogUDF4')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogUDF4">Partner Log UDF 4</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('partnerLogUDF5')}>
                  <Translate contentKey="vpay02App.partnerLog.partnerLogUDF5">Partner Log UDF 5</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('isDeleted')}>
                  <Translate contentKey="vpay02App.partnerLog.isDeleted">Is Deleted</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="vpay02App.partnerLog.partner">Partner</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
