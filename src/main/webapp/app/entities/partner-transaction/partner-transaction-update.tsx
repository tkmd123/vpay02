    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay02App.partnerTransaction.home.createOrEditLabel">
              <Translate contentKey="vpay02App.partnerTransaction.home.createOrEditLabel">Create or edit a PartnerTransaction</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : partnerTransactionEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    ...
                    <Translate contentKey="vpay02App.partnerTransaction.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label for="productType.id">
                    <Translate contentKey="vpay02App.partnerTransaction.productType">Product Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="partner.id">
                    <Translate contentKey="vpay02App.partnerTransaction.partner">Partner</Translate>
                  </Label>
