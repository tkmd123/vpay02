  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="vpay02App.walletTransaction.delete.question">
          <Translate contentKey="vpay02App.walletTransaction.delete.question" interpolate={{ id: walletTransactionEntity.id }}>
