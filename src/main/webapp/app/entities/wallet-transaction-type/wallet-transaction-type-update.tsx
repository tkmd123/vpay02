    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay02App.walletTransactionType.home.createOrEditLabel">
              <Translate contentKey="vpay02App.walletTransactionType.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : walletTransactionTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    ...
                    <Translate contentKey="vpay02App.walletTransactionType.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
