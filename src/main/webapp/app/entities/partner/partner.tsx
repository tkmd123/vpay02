    ...
    return (
      <div>
        <h2 id="partner-heading">
          <Translate contentKey="vpay02App.partner.home.title">Partners</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="vpay02App.partner.home.createLabel">Create new Partner</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('vpay02App.partner.home.search')}
                  />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('partnerCode')}>
                    <Translate contentKey="vpay02App.partner.partnerCode">Partner Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerName')}>
                    <Translate contentKey="vpay02App.partner.partnerName">Partner Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerDesc')}>
                    <Translate contentKey="vpay02App.partner.partnerDesc">Partner Desc</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerOrder')}>
                    <Translate contentKey="vpay02App.partner.partnerOrder">Partner Order</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerAPIUsername')}>
                    <Translate contentKey="vpay02App.partner.partnerAPIUsername">Partner API Username</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerAPIPassword')}>
                    <Translate contentKey="vpay02App.partner.partnerAPIPassword">Partner API Password</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerUrl')}>
                    <Translate contentKey="vpay02App.partner.partnerUrl">Partner Url</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerStatus')}>
                    <Translate contentKey="vpay02App.partner.partnerStatus">Partner Status</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerUDF1')}>
                    <Translate contentKey="vpay02App.partner.partnerUDF1">Partner UDF 1</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerUDF2')}>
                    <Translate contentKey="vpay02App.partner.partnerUDF2">Partner UDF 2</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('partnerUDF3')}>
                    <Translate contentKey="vpay02App.partner.partnerUDF3">Partner UDF 3</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('isDeleted')}>
                    <Translate contentKey="vpay02App.partner.isDeleted">Is Deleted</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
