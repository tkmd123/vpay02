    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay02App.wallet.home.createOrEditLabel">
              <Translate contentKey="vpay02App.wallet.home.createOrEditLabel">Create or edit a Wallet</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : walletEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="walletNumberLabel" for="walletNumber">
                    <Translate contentKey="vpay02App.wallet.walletNumber">Wallet Number</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="walletIsActiveLabel" check>
                    ...
                    <Translate contentKey="vpay02App.wallet.walletIsActive">Wallet Is Active</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label id="walletDescLabel" for="walletDesc">
                    <Translate contentKey="vpay02App.wallet.walletDesc">Wallet Desc</Translate>
                  </Label>
                  <AvField id="wallet-walletDesc" type="text" name="walletDesc" />
                </AvGroup>
                <AvGroup>
                  <Label id="walletUDF1Label" for="walletUDF1">
                    <Translate contentKey="vpay02App.wallet.walletUDF1">Wallet UDF 1</Translate>
                  </Label>
                  <AvField id="wallet-walletUDF1" type="text" name="walletUDF1" />
                </AvGroup>
                <AvGroup>
                  <Label id="walletUDF2Label" for="walletUDF2">
                    <Translate contentKey="vpay02App.wallet.walletUDF2">Wallet UDF 2</Translate>
                  </Label>
                  <AvField id="wallet-walletUDF2" type="text" name="walletUDF2" />
                </AvGroup>
                <AvGroup>
                  <Label id="walletUDF3Label" for="walletUDF3">
                    <Translate contentKey="vpay02App.wallet.walletUDF3">Wallet UDF 3</Translate>
                  </Label>
                  <AvField id="wallet-walletUDF3" type="text" name="walletUDF3" />
                </AvGroup>
                <AvGroup>
                  <Label id="walletUDF4Label" for="walletUDF4">
                    <Translate contentKey="vpay02App.wallet.walletUDF4">Wallet UDF 4</Translate>
                  </Label>
                  <AvField id="wallet-walletUDF4" type="text" name="walletUDF4" />
                </AvGroup>
                <AvGroup>
                  <Label id="walletUDF5Label" for="walletUDF5">
                    <Translate contentKey="vpay02App.wallet.walletUDF5">Wallet UDF 5</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    ...
                    <Translate contentKey="vpay02App.wallet.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label for="productType.id">
                    <Translate contentKey="vpay02App.wallet.productType">Product Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="partner.id">
                    <Translate contentKey="vpay02App.wallet.partner">Partner</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="payPartner.id">
                    <Translate contentKey="vpay02App.wallet.payPartner">Pay Partner</Translate>
                  </Label>
