    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay02App.walletRule.home.createOrEditLabel">
              <Translate contentKey="vpay02App.walletRule.home.createOrEditLabel">Create or edit a WalletRule</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : walletRuleEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="walletRuleCodeLabel" for="walletRuleCode">
                    <Translate contentKey="vpay02App.walletRule.walletRuleCode">Wallet Rule Code</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="walletRuleNameLabel" for="walletRuleName">
                    <Translate contentKey="vpay02App.walletRule.walletRuleName">Wallet Rule Name</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="walletRuleDescLabel" for="walletRuleDesc">
                    <Translate contentKey="vpay02App.walletRule.walletRuleDesc">Wallet Rule Desc</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    ...
                    <Translate contentKey="vpay02App.walletRule.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label for="productType.id">
                    <Translate contentKey="vpay02App.walletRule.productType">Product Type</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="payPartner.id">
                    <Translate contentKey="vpay02App.walletRule.payPartner">Pay Partner</Translate>
                  </Label>
