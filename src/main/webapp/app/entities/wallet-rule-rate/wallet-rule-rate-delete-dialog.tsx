  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="vpay02App.walletRuleRate.delete.question">
          <Translate contentKey="vpay02App.walletRuleRate.delete.question" interpolate={{ id: walletRuleRateEntity.id }}>
