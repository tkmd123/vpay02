    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="vpay02App.walletRuleRate.home.createOrEditLabel">
              <Translate contentKey="vpay02App.walletRuleRate.home.createOrEditLabel">Create or edit a WalletRuleRate</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : walletRuleRateEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="isDeletedLabel" check>
                    ...
                    <Translate contentKey="vpay02App.walletRuleRate.isDeleted">Is Deleted</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label for="walletRule.id">
                    <Translate contentKey="vpay02App.walletRuleRate.walletRule">Wallet Rule</Translate>
                  </Label>
