...
To optimize the vpay02 application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v5.6.0/doing-api-first-development/
